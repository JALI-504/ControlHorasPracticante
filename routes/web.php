...
use App\Http\Livewire\UsuariosOff;

Auth::routes();

Route::get('/', Inicio::class)->name('inicio')->middleware(['auth', 'estado.usuario']);

Route::prefix('usuarios')->group(function () {
    Route::get('index', Usuarios::class)->name('usuario.index')->middleware(['auth', 'estado.usuario']);
    Route::get('desactivados', UsuariosOff::class)->name('usuario.desactivados')->middleware(['auth', 'estado.usuario']);
    Route::get('create', UsuariosCreate::class)->name('usuario.create')->middleware('auth');
    Route::get('perfil/{id}', Perfil::class)->name('usuario.perfil')->middleware(['auth', 'estado.usuario']);
...
Route::prefix('centros')->group(function () {
    Route::get('index', Centros::class)->name('centro.index')->middleware(['auth', 'estado.usuario']);
...
Route::prefix('carreras')->group(function () {
    Route::get('index', Carreras::class)->name('carrera.index')->middleware(['auth', 'estado.usuario']);
...
Route::prefix('supervisores')->group(function () {
    Route::get('index', Supervisores::class)->name('sup.index')->middleware(['auth', 'estado.usuario']);
...
Route::prefix('horas')->group(function () {
    Route::get('index', Horas::class)->name('hora.index')->middleware(['auth', 'estado.usuario']);
    Route::get('registro/{id}', HorasRegistro::class)->name('hora.registro')->middleware(['auth', 'estado.usuario']);
...
Route::prefix('deptos')->group(function () {
    Route::get('index', Deptos::class)->name('depto.index')->middleware(['auth', 'estado.usuario']);
